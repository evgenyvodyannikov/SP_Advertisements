...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FullAdvertisementsUserControl.ascx.cs" Inherits="AdvertisementsList.FullAdvertisements.FullAdvertisementsUserControl" %>
