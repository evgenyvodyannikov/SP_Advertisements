...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FullAdvertisementWebPart.ascx.cs" Inherits="AdvertisementList.FullAdvertisementWebPart.FullAdvertisementWebPart" %>
...
<div id="wrapper">
						...
						<div class="content-box">
							...
							<div class="desk-item-box section-padding">
								<div class="hh">
									...
									<div class="who">
										<a href="">
										<div class="img"><img src="../_layouts/15/AdvertisementList/img/new1.png" alt=""></div>
    ...
    <script src="../_layouts/15/AdvertisementList/js/fullAdvertisement.js"></script>
